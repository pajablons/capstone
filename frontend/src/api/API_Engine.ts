...
export default class API_Engine {
    static async generateRoute(waypoints: Array<Waypoint>): Promise<Array<Feature<Geometry>>> {
    ...
    static async loadIZL(searchArea: Array<Feature<Geometry>>, waypoints: Array<Waypoint>): Promise<Array<Feature<Geometry>>> {
